...
class State():
    ...
    def __enter__(self) -> dict:
        ...
        try:
            ...
            o.info("Using found .ostate", 2)
        except (json.JSONDecodeError, FileNotFoundError):
            o.warn("New .ostate created", 2)
            ret = {
                    "repos": []
                }
            self.ret = ret
        o.info(f'Loaded .ostate = \n {self.ret}', 3)
        return self.ret

    def __exit__(self, exc_type, exc_value, traceback):
        with open(".orc", "w") as f:
            json.dump(self.ret, f, cls=OJSONEncoder)
            o.info(f'Saving to .ostate = \n {self.ret}', 3)
